...
6. You need to run CreamAPI. It is not hard; you just select Hoi4 and hit the '+' by the game name and '✓'. It does not add DLCs; it makes it so it does not have a red triangle and it works in online. I would not recommend it, as it could get you banned from online. Link: https://github.com/ubden/CreamApi-CreamInstaller
